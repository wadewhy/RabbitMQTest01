...
public class Rece1 {
    /**
     * 1.队列名称和交换机名称 2.获取连接和channel通道 声明队列 3.绑定队列到交换机 4.满足公平分发[能者多劳] 5.触发事件 6.获取消息
     * 7.反馈消费状态
     */
    // 1.队列名称和交换机名称[队列名模拟发短息]
    private final static String QUEUE_NAME = "queue_exchange_SMS";
    ...
    public static void main(String[] args) throws IOException, TimeoutException {
        ...
        // 3.绑定队列到交换机
        /**
         * 交换机名字要和Send里的一致 参数1：队列名称 参数2：交换机名称 参数3：Routing keys
         */
